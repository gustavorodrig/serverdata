package com.serverdata.repository;

import com.serverdata.config.ServerDataApplication;
...
public class ServerRepositoryTest {
    ...
    @Test
    public void testeListOfServers() {
